...
RUN_ROOT=${PROJECT_ROOT}/blt1b_warmstart/entropy_randominit_A1k_B50k_6gpu_c00000_c00005
...
run_torchrun \
  ...
  name=entropy_bands_phaseA_1k_6gpu_c00000_c00005 \
  steps=1000 \
  max_steps=1000 \
...
run_torchrun \
  ...
  name=entropy_bands_phaseB_total50k_6gpu_c00000_c00005 \
  steps=49000 \
  max_steps=49000 \

...
RUN_ROOT=${PROJECT_ROOT}/blt1b_warmstart/entropy_length_A3k_B47k_6gpu_c00000_c00005
...
run_torchrun \
  ...
  name=entropy_length_phaseA_3k_6gpu_c00000_c00005 \
  steps=3000 \
  max_steps=3000 \
...
run_torchrun \
  ...
  name=entropy_length_phaseB_total50k_6gpu_c00000_c00005 \
  steps=47000 \
  max_steps=47000 \

...
RUN_ROOT=${PROJECT_ROOT}/blt1b_warmstart/natural_granularity_A3k_B47k_6gpu_c00000_c00005

PHASE_A_DIR=${RUN_ROOT}/phaseA_3k
...
run_torchrun \
  ...
  name=natural_granularity_phaseA_3k_6gpu_c00000_c00005 \
  steps=3000 \
  max_steps=3000 \
...
run_torchrun \
  ...
  name=natural_granularity_phaseB_total50k_6gpu_c00000_c00005 \
  steps=47000 \
  max_steps=47000 \

...
#
# Defaults intentionally run the minimal decisive controls:
#   dense                  no MoE
#   byte_hidden_only_w005  MoE + byte balance, no side features
#   byte_entropy_length_w005
#                          MoE + byte balance, entropy + length side features
#
...
SEEDS="${SEEDS:-779}"
VARIANTS="${VARIANTS:-dense byte_hidden_only_w005 byte_entropy_length_w005}"

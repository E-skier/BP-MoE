...
RUN_DIR="$ROOT_DIR/experiments/bcfp_cpt/C_byte_aux_002_screenlike_10k_6gpu_nofused_clip0_ckpt100k_fresh"
...
exec env CUDA_VISIBLE_DEVICES=0,1,2,3,4,5 \
  ...
  dump_dir="$RUN_DIR" \
  name=C_byte_aux_002_screenlike_10k_6gpu_nofused_clip0_ckpt100k_fresh \
  steps=10000 \
  max_steps=10000 \
  grad_acc_steps=1 \

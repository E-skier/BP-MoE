...
RUN_DIR="$ROOT_DIR/experiments/bcfp_cpt/C_byte_aux_002_screenlike_5k_6gpu_nofused_clip0_ckpt100k_retry2"
CKPT_DIR="$RUN_DIR/checkpoints/0000005000"
EVAL_DIR="$RUN_DIR/heldout_eval_expanded_100k_8000batches_0to5_retry"
...
exec env CUDA_VISIBLE_DEVICES=5 \
  /home/pengfeigao/.local/bin/uv run torchrun --standalone --nproc-per-node=1 -m bytelatent.eval \
  "ckpt_dir=$CKPT_DIR" \
  "dump_dir=$EVAL_DIR" \
